...
def load_spec(path: str | Path) -> FundSpec:
    ...
    # Explicit utf-8: bare open() decodes with the locale code page, and the
    # shipped YAML is utf-8. On a non-utf-8 default (cp949, cp1252) an em-dash
    # in a description is a UnicodeDecodeError before validation ever runs.
